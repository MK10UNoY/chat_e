...
<footer class="bg-linear-180 from-transparent to-[#0c0d10] text-neutral-400">
	<div class="mx-auto flex max-w-7xl flex-col gap-8 px-6 py-12">
		<!-- Top Section -->
		<div class="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
			<!-- Logo -->
			<div class="flex items-center gap-3">
				<img src="favicon.svg" alt="" class="h-8" />
				<span class="text-2xl font-light text-neutral-200 italic">Chat.E</span>
			</div>

			<!-- Navigation Links -->
			<nav class="flex flex-wrap gap-6">
				{#each navLinks as link}
					<a href={link.href} class="text-sm transition-colors hover:text-neutral-100"
						>{link.name}</a
					>
				{/each}
			</nav>
		...
		<div class="flex flex-col gap-4 text-sm md:flex-row md:items-center md:justify-between">
			<div class="text-neutral-400">
				© 2025 <span class="text-neutral-100">Chat.E Company Pvt. Ltd.</span>
			</div>

			<div class="flex items-center w-fit gap-4">
				<span class="w-max">Made in</span>
				<svg
				class="w-8 rounded-lg"
					...
					><style type="text/css">
						...
						><rect class="st0" height="298.7" width="512" y="106.7" /><rect
							class="st1"
							height="99.6"
							width="512"
							y="106.7"
						/><rect class="st2" height="99.6" width="512" y="305.8" /><path
							class="st3"
						...
						/><path
							class="st0"
							d="M256,249.3c3.7,0,6.7,3,6.7,6.7c0,3.7-3,6.7-6.7,6.7c-3.7,0-6.7-3-6.7-6.7C249.3,252.3,252.3,249.3,256,249.3"
						/><path
							class="st3"
							d="M256,250.8c2.9,0,5.2,2.3,5.2,5.2c0,2.9-2.3,5.2-5.2,5.2c-2.9,0-5.2-2.3-5.2-5.2   C250.8,253.2,253.2,250.8,256,250.8"
						/></g
					></svg
				>
			</div>
